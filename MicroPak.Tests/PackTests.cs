...
public class PackTests
{
    ...
    {
        // Act
        var actual = Pak.Create(new Dictionary<string, byte[]>());
    ...
    public void TestAsciiTxt()
    {
        ...
        {
            ["CoolGame/Content/Dir1/Dir2/FileA.txt"] = "Hello, world!\r\n"u8.ToArray(),
            ["CoolGame/Content/Dir1/Dir2/FileB.txt"] = "Goodbye, world!\r\n"u8.ToArray()
        };
